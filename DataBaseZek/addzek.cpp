...
void AddZek::slotImg()
{
    ...
    else
    {
       ...
       i->save("D:/Qt bazaZek/"+ui->textEdit_9->toPlainText()+".jpg");
       QPixmap *p = new QPixmap("D:/Qt bazaZek/"+ui->textEdit_9->toPlainText()+".jpg");
...
void AddZek::slotSave()
{
    ...
    *stream << ui->textEdit_9->toPlainText() <<endl;
    f->close();
    f =  new QFile("D:/Qt bazaZek/"+ui->textEdit_9->toPlainText()+".txt");
